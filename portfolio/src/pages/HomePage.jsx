    ...
    <div className=" mt-40 flex space-x-40">
      ...
      <div className=" text-white">
        ...
        <p className="text-base mt-10">
          A Frontend Developer and a fervent learner from Sri Krishna College of
          Technology. With expertise in C++, Java, HTML, CSS, JavaScript,
          ...
          quality, a testament to my passion for technology, and a reflection of
